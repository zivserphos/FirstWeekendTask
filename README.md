...
*read all the tasks before starting*
...
- [ ] Submit issues  on your friends repos with improvements suggestions
- [ ] Bonus  - remove the tests scripts from the html head and add them as local js file
